...
local lockscren = require("widgets.lock_screen")
-- Appearance
local icon_size = beautiful.exit_screen_icon_size or dpi(150)
...
screen.connect_signal("request::desktop_decoration", function(s)
	...
	s.exit_screen.bg = beautiful.xbackground .. "80"
	s.exit_screen.fg = beautiful.xforeground or beautiful.exit_screen_fg or beautiful.wibar_fg or '#FEFEFE'
