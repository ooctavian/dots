...
awful.screen.connect_for_each_screen(function(s)
   ...
   layout          = {
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s ,x = 4, width = 105, y=10 })
    s.mywibox.x = 23 
    s.mywibox.y = 735 
...
awful.key({ modkey,  }, "d", function()awful.spawn("rofi -show drun -theme ~/.config/rofi/themes/run.rasi")  end,
...
client.connect_signal("request::titlebars", function(c)
    ...
    awful.titlebar(c,{position = "left", size =15}) : setup {
        { -- Left
