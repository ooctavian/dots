...
user = {
    ...
    terminal = "st ",
    floating_terminal = "st -1",
    browser = "firefox",
    file_manager = "thunar",
    tmux = "st -1 -e tmux new",
    editor = "st -1 --class editor -e vim",
    -- editor = "emacs",
    ...
    -- >> Music <<
    music_client = "st -1 --class music -e ncmpcpp",
    ...
    -- >> Email <<
    email_client = "st -1 --class email -e neomutt",
